...
class Task1 {
  public static void main(String[] args) {
    ...
    chessPieces[0] = chessPieces[1] = chessPieces[2] = chessPieces[3] = ChessPiece.PAWN_WHITE;
    chessPieces[4] = chessPieces[5] = chessPieces[6] = chessPieces[7] = ChessPiece.ROOK_BLACK;
...
class Task2 {
  public static void main(String[] args) {
    ...
    chessPieces[0][6] = ChessPiece.QUEEN_BLACK;
    ...
    chessPieces[2][6] = ChessPiece.PAWN_WHITE;
